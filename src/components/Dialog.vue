  ...
  <transition name="dialog">
    ...
    >
      ...
      <div
        ...
        :style="{ minHeight: virtualContainerMinHeight }"
      >
        <div
          :class="[
            'ds-dialog-content',
            {
              'ds-border-content': borderColor,
              'ds-full-screen-content': fullScreen,
              'ds-full-screen-active-content': fullScreenActive,
              'ds-full-width': contentFullWidth,
              'ds-dialog-datepicker-container': datepickerContainer,
              'ds-dialog-top-offset': top
            }
          ]"
          :style="{
            borderColor,
...
export default {
  ...
  data: () => ({
    ...
    $_defaultStyles: {},
    idContent: 'ds-dialog-content-'.concat(
      Math.random()
        .toString(15)
        .substring(5)
    ),
  ...
  methods: {
    ...
    openedDispatchWrapper(backdropClick) {
      ...
      if (
        ...
        this.activeDatepickerComponent === 'Dialog'
      ) {
